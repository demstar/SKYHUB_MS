...
body {
    ...
    background-image: url('assets/images/ai.png'); /* Path to your image */
...
<link rel="stylesheet" type="text/css"
	...
	<div class="main-agileinfo">
		...
		SKYHUB AIRWAYS MANAGEMENT SYSTEM</h1>
		<div class="sap_tabs">			
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="clear"></div>
							<input type="submit" value="Search Flights" name="search_but" class="btn btn-primary rounded-pill">
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class=" text-center">&copy; <?php echo date('Y')?> - SKYHUB AIRWAYS MANAGEMENT SYSTEM<br><br></div>
	<!-- <p>----------</p> -->
