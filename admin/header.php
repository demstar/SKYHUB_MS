...
<html lang="en">
    <head>
        ...
        <title>SKYHUB AIRWAYS MANAGEMENT SYSTEM</title>          
        <link rel = "icon" href =  
...
.table .thead-dark th{
  background-color: #ff8a10;
    ...
    <nav class="navbar navbar-custom navbar-expand-lg navbar-dark" style="background-color: #ff8a10;">

          <a class="navbar-brand text-light" href="index.php"><h4>SKYHUB Admin</h4></a>
